...
class AgeCalculator(QWidget):
    def __init__(self):
        ...
        # Set up the layout for the grid
        ...
        self.setLayout(grid) # setLayout inherited from QWidget
    ...
    def calculate_age(self):
        ...
        self.output_label.setText(f"{self.name_line_edit.text()} age is: {age} years old.")
